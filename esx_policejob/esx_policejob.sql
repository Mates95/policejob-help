...
INSERT INTO `job_grades` (job_name, grade, name, label, salary, skin_male, skin_female) VALUES
	('police',0,'recruit','Kadet',500,'{}','{}'),
	('police',1,'officer','Rotmistr',1000,'{}','{}'),
	('police',2,'sergeant','Serzant',2000,'{}','{}'),
	('police',3,'lieutenant','Porucik',2500,'{}','{}'),
	('police',4,'swat','SWAT Zamestnanec',2800,'{}','{}')
	('police',5,'fib','FIB Zamestnanec',2800,'{}','{}')
	('police',6,'swatboss','SWAT Sef',3400,'{}','{}')
	('police',7,'fibboss','FIB Sef',3400,'{}','{}')
	('police',8,'boss','Generalmajor',3100,'{}','{}')
;
