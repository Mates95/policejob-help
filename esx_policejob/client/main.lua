...
function OpenCloakroomMenu()
  ...
  if PlayerData.job.grade_name == 'capitan' then
    table.insert(elements, {label = _U('police_wear'), value = '_wear'})
  end

  if PlayerData.job.grade_name == 'plukovnik' then
    table.insert(elements, {label = _U('police_wear'), value = 'commandant_wear'})
  end


  if PlayerData.job.grade_name == 'swatrecruit' then
    table.insert(elements, {label = _U('police_wear'), value = 'swatboss_wear'})
  end

  if PlayerData.job.grade_name == 'swatofficer' then
    table.insert(elements, {label = _U('police_wear'), value = 'swatboss_wear'})
  end

  if PlayerData.job.grade_name == 'swatsergeant' then
    table.insert(elements, {label = _U('police_wear'), value = 'swatboss_wear'})
  end

  if PlayerData.job.grade_name == 'swatlieutenant' then
    table.insert(elements, {label = _U('police_wear'), value = 'swatboss_wear'})
  end

  if PlayerData.job.grade_name == 'swatboss' then
    table.insert(elements, {label = _U('police_wear'), value = 'swatboss_wear'})
  end
  ...
  if Config.EnableNonFreemodePeds then
    ...
    table.insert(elements, {label = _U('swatboss_wear'), value = 'lieutenant_wear_freemode', maleModel = 's_m_y_swat_01', femaleModel = 's_m_y_swat_01'})
  ...
  ESX.UI.Menu.Open(
    ...
    function(data, menu)
      ...
      if
        ...
        data.current.value == 'swatboss_wear' or
      ...
      if
        ...
        data.current.value == 'swatboss_wear_freemode' or
...
function OpenArmoryMenu(station)
  ...
  if Config.EnableArmoryManagement then
    ...
    if PlayerData.job.grade_name == 'boss' or 'swatboss' then
  ...
  while true do
    ...
    if PlayerData.job ~= nil and PlayerData.job.name == 'police' then
      ...
      for k,v in pairs(Config.PoliceStations) do
        ...
        if Config.EnablePlayerManagement and PlayerData.job ~= nil and PlayerData.job.name == 'police' and PlayerData.job.grade_name == 'boss' or 'swatboss' then
